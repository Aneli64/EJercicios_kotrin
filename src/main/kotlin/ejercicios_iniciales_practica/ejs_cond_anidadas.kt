...
fun main(){
    ...
    var list = listOf(valor1, valor2, valor3)
    println("Valor mayor -> ${list.max()}")
     */
    /*
    ...
    val valor = readln()
    //revisar el nulo
        if (valor.toInt() >= 0) print("Numero positivo")
        else if (valor.toInt() < 0) print("Numero negativo")
        else if (valor == "") println("Numero nulo")
    */
    /*
