...
- Mediante un bucle, llame al método tictac 1000 veces, simulando que han pasado 1000 segundos. Cada vez que llames a tictac, imprime la hora actual.
* Comprueba que la alarma ha sonado a la hora correcta.
OPCIONAL: Haz que tictac sea llamado cada segundo 'real'. Para eso puedes usar la clase timer. En tal caso,
no realices 1000 llamadas a tictac, puesto requeriría esperar mucho para que el programa finalice. Haz que tictac sea
llamado sólo 10 veces. Por otro lado, haz que, desde la hora inicial del reloj hasta la hora de la alarma, haya sólo
5 segundos de diferencia, para que la alarme suene antes de finalizar el programa.
 */
